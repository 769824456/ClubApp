package win.yulongsun.yulongsunutils.image;
...
public class ImageLoadManager {
    ...
    public ImageLoadManager load(String url){
        builder = requestManager.load(url).diskCacheStrategy(DiskCacheStrategy.RESULT);
        return this;
    }

    public ImageLoadManager load(int resId){
        builder = requestManager.load(resId).diskCacheStrategy(DiskCacheStrategy.RESULT);
        return this;
    }

    public ImageLoadManager load(Uri uri){
        builder = requestManager.load(uri).diskCacheStrategy(DiskCacheStrategy.RESULT);
        return this;
    }
