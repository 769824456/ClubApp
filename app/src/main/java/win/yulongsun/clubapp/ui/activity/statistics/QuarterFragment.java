...
public class QuarterFragment extends Fragment {
    ...
    private static final String TAG = QuarterFragment.class.getSimpleName();
    ...
    private LineData getLineData(List<ChartVo> chartVoList) {
        ...
        // y轴的数据集合
        LineDataSet lineDataSet = new LineDataSet(yValues, "当季销售额");
    ...
    private void showChart(LineChart lineChart, LineData lineData) {
        ...
        lineChart.setNoDataTextDescription("这季度还没有营业数据");
